class TipoSalidasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_salida.save
        format.html { redirect_to @tipo_salida, notice: 'Tipo salida se creo con exito.' }
  ...
  def update
    respond_to do |format|
      if @tipo_salida.update(tipo_salida_params)
        format.html { redirect_to @tipo_salida, notice: 'Tipo salida se actualizo con exito!.' }
  ...
  def destroy
    @tipo_salida.destroy
    respond_to do |format|
      format.html { redirect_to tipo_salidas_url, notice: 'Tipo salida se elimino con exito!.' }
